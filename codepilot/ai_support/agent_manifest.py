    ...
    return {
        ...
        "commands": [
            ...
            },
            {
                ...
                "examples": [_cmd(command, "binary prepare --version 0.7.3")],
            },
            {
                "name": "binary_release",
            ...
            },
            {
                ...
                "examples": [
                    ...
                    _cmd(command, "binary verify --release-dir dist/release/codepilot-0.7.2-summary"),
                ],
            },
            {
                "name": "ai_template",
...
def _english_command_manifest(*, command: str, version: str, binary: str) -> dict[str, Any]:
    ...
    return {
        ...
        "commands": [
            ...
            {"name": "binary_prepare", "syntax": _cmd(command, "binary prepare --version <version>"), "purpose": "Update version, build the current platform, generate a release directory, and verify it.", "when_to_use": "Use to prepare a local release package.", "examples": [_cmd(command, "binary prepare --version 0.7.3")]},
