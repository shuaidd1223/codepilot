...
def project_workflow_payload(project: str) -> dict:
    ...
    return {
        ...
        "inspect": {
            ...
            "ignored_report_only": inspect_context.get("ignored_report_only") or [],
            "deleted_report_only": inspect_context.get("deleted_report_only") or [],
            "archived_report_only": inspect_context.get("archived_report_only") or [],
