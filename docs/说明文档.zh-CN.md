...
- 操作文档：[中文](操作文档.zh-CN.md) / [English](操作文档.en-US.md)
- AI/Agent 调用：[中文](AI与Agent调用手册.zh-CN.md) / [English](AI与Agent调用手册.en-US.md)
- Skill 化集成：[中文](Skill化集成指南.zh-CN.md) / [English](Skill化集成指南.en-US.md)
- 项目服务说明：[中文](project-services.md) / [English](project-services.en-US.md)
- 工作流状态约定：[中文](workflow-state.zh-CN.md) / [English](workflow-state.en-US.md)
