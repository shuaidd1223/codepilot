"""MCP stdio smoke test shim — client + fixture for end-to-end MCP tool tests."""
...
class _MCPStdioSmokeClient:
    """Lightweight JSON-RPC client for a long-running MCP stdio subprocess."""
...
def _write_fastmcp_stdio_shim(root: Path) -> None:
    """Write a minimal FastMCP shim under *root* so the MCP server can import it."""
